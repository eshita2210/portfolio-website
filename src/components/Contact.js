...
emailjs.init('-64lRXxU9GpIdAEc2'); // Initialize EmailJS with your user ID--64lRXxU9GpIdAEc2
...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setButtonText("Sending...");
    try {
      const serviceId = "service_vw5dhaj"; //service id hai
      const templateId = "template_hyhg2tc"; // template id hai
